    ...
    return (
        <>
            ...
            <div className="signup-1 flex items-center relative h-screen">
                <div className="overlay absolute inset-0 z-0 bg-gray-100"></div>
                <div className="container px-4 mx-auto relative z-10 ">
                    <div className="sm:w-10/12 md:w-8/12 lg:w-6/12 xl:w-5/12 mx-auto ">
                        <div className="box bg-white p-6 md:px-12 md:pt-12 border-t-10 border-solid border-[#ea2537] shadow-lg">
                            ...
                            <div className="signup-form mt-6 md:mt-12">
                                ...
                                <div className="border-2 border-solid rounded flex items-center mb-4">
                                    <div className="w-10 h-10 flex justify-center items-center flex-shrink-0">
                                        <span className="far fa-user text-gray-500"><MdPersonOutline /></span>
                                    </div>
                                    <div className="flex-1">
                                        <input type="text" placeholder="First Name" className="h-10 py-1 pr-3 w-full focus:outline-none" value={form.firstName}
                                            onChange={(e) => {
                                ...
                                <div className="border-2 border-solid rounded flex items-center mb-4">
                                    ...
                                    <div className="flex-1">
                                        <input type="text" placeholder="Last Name" className="h-10 py-1 pr-3 w-full focus:outline-none " value={form.lastName}
                                            onChange={(e) => {
                                ...
                                <div className="border-2 border-solid rounded flex items-center mb-4">
                                    <div className="w-10 h-10 flex justify-center items-center flex-shrink-0">
                                        <span className="far fa-envelope text-gray-500"><FaRegEnvelope /></span>
                                    </div>
                                    <div className="flex-1">
                                        <input type="text" placeholder="Email" className="h-10 py-1 pr-3 w-full  focus:outline-none " value={form.email}
                                            onChange={(e) => {
                                ...
                                <div className="border-2 border-solid rounded flex items-center mb-4">
                                    <div className="w-10 h-10 flex justify-center items-center flex-shrink-0">
                                        <span className="far fa-user text-gray-500"><FiPhone /></span>
                                    </div>
                                    <div className="flex-1">
                                        <input type="text" placeholder="Phone" className="h-10 py-1 pr-3 w-full focus:outline-none " value={form.phone}
                                            onChange={(e) => {
                                ...
                                <div className="border-2 border-solid rounded flex items-center mb-4">
                                    <div className="w-10 h-10 flex justify-center items-center flex-shrink-0 ">
                                        <span className="fas fa-asterisk text-gray-500"><FaStarOfLife /></span>
                                    </div>
                                    <div className="flex-1">
                                        <input type="password" placeholder="Password" className="h-10 py-1 pr-3 w-full focus:outline-none focus:border-blue-400" value={form.password}
                                            onChange={(e) => {
                            ...
                            <div className="border-t flex justify-center border-solid mt-6 md:mt-12 pt-4">
                                <p className="text-gray-500 text-center mr-1">Already have an account,</p>
                                <Link href="/login">
